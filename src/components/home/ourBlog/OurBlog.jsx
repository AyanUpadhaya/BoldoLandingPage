...
const OurBlog = () => {
  return (
    <div className="max-w-[1200px] mx-auto relative z-[100] mb-[60px] lg:mb-[120px] py-[60px] lg:py-[84px]">
        ...
        <div className="flex flex-col items-start w-full ">
          ...
          <div className="flex flex-col justify-between gap-5  h-full">
            <div className="flex flex-col gap-3">
              <div>
                <div className="border-none outline-none flex items-center gap-4 ">
                  <span className="text-xl font-bold text-darkBlue ">
                    Category
                  </span>
                  <span className={"text-gray font-openSans"}>
                    November 22, 2021
                  </span>
                </div>
              </div>
      ...
      <div className="flex justify-center">
        <button className="py-4 px-14 text-darkBlue bg-white rounded-full border-2 border-darkBlue text-xl font-bold transition-transform duration-200 transform active:scale-95">
          Load More
        </button>
      </div>
    </div>
